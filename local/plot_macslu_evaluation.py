...
def plot_slot_type_metrics(metrics: Dict[str, Dict[str, float]], output_stem: str, title: str) -> None:
...
def plot_slot_type_metric_charts(output_dir: str) -> None:
...
def main() -> None:
    ...
    if not args.skip_plots:
        configure_fonts()
        plot_slot_type_metric_charts(args.output_dir)
