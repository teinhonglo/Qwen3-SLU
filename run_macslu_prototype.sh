...
#         metrics_proto.txt for every split, and creates data-json/macslu_prototype.
...
prototype_json_root="data-json/macslu_prototype"
...
prototype_exp_dir="exp/macslu_prototype/prototype_only"
